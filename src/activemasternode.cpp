...
//
// Bootup the masternode, look for a 100000 BTCRP input and register on the network
//
void CActiveMasternode::ManageStatus()
{
    ...
    if(status == MASTERNODE_NOT_PROCESSED) {
        ...
        if(GetMasterNodeVin(vin, pubKeyCollateralAddress, keyCollateralAddress)) {
            ...
            /* rewards are not supported in BitCurrencyPro.conf */
...
{
    CBitCurrencyProcoinAddress address(collateralAddress);
