...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("BTCRP");
    case mBTC: return QString("mBTCRP");
    case uBTC: return QString::fromUtf8("μBTCRP");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("BitCurrencyPros");
    case mBTC: return QString("Milli-BitCurrencyPros (1 / 1,000)");
    case uBTC: return QString("Micro-BitCurrencyPros (1 / 1,000,000)");
    default: return QString("???");
    }
}
