...
private slots:
    ...
    QString BuyBTCRP(QString OrderType, double Quantity, double Rate);
    QString SellBTCRP(QString OrderType, double Quantity, double Rate);
